...
class frmMain ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.matPlotPanelImg.SetMinSize( wx.Size( 100,100 ) )

		gSizer2.Add( self.matPlotPanelImg, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.matPlotPanelImg1.SetMinSize( wx.Size( 100,100 ) )

		gSizer21.Add( self.matPlotPanelImg1, 0, wx.ALL|wx.EXPAND, 5 )
